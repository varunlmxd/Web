...
document.getElementById("0").addEventListener("click",result);
document.getElementById("1").addEventListener("click",result);
document.getElementById("2").addEventListener("click",result);
